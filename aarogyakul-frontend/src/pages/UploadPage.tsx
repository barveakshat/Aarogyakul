  ...
  return (
    <Card className="p-5">
      ...
      {document.insight?.summaryText ? (
        <div className="mt-5 rounded-crd border border-emerald-100 bg-gradient-to-br from-mint/70 to-white p-4">
          <div className="text-sm font-black text-txtP">AI summary</div>
          <p className="mt-2 text-sm leading-6 text-txtS">{document.insight.summaryText}</p>
        </div>
      ) : null}
