-- ============================================================
-- V1: Baseline schema for AarogyaKul
-- This migration matches the existing database structure.
-- Flyway baseline-on-migrate will skip this on existing DBs.
-- ============================================================
...
ALTER TABLE families ADD CONSTRAINT uq_families_owner_id UNIQUE (owner_id);
